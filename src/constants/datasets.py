...
# WALMART_DATASET_CONSTANTS = DATASET_CONSTANTS(
#     VALUE={
#         'NAME': 'walmart',
...
#         'KEY': ['BRAND'],
#         'REST': ['index','SHIPPING_LOCATION','DEPARTMENT','CATEGORY','SUBCATEGORY','BREADCRUMBS','SKU','PRODUCT_URL','PRODUCT_NAME','PRICE_RETAIL','PRICE_CURRENT','PRODUCT_SIZE','RunDate','tid']
#     }
# )

# PHONE_DATASET_CONSTANTS = DATASET_CONSTANTS(
#     VALUE={
#         'NAME': 'phone',
...
#         'KEY': ['brand'],
#         'REST': ['model', 'network_technology', '2G_bands', '3G_bands', '4G_bands', 'network_speed', 'GPRS', 'EDGE', 'announced', 'status', 'dimentions', 'weight_g', 'weight_oz', 'SIM', 'display_type', 'display_resolution', 'display_size', 'OS', 'CPU', 'Chipset', 'GPU', 'memory_card', 'internal_memory', 'RAM', 'primary_camera', 'secondary_camera', 'loud_speaker', 'audio_jack', 'WLAN', 'bluetooth', 'GPS', 'NFC', 'radio', 'USB', 'sensors', 'battery','colors', 'approx_price_EUR', 'img_url']
#     }
# )
